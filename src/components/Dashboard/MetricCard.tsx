...
export function MetricCard({ 
  ...
  return (
    <div className={`bg-gradient-to-br ${bgGradient} overflow-hidden shadow-sm rounded-lg border border-gray-200 hover:shadow-md transition-all duration-200 hover:scale-105`}>
      <div className="p-5">
